...
public class LabelLineChart extends ChartBean {
	...
	public LabelLineChart() {
		...
		chart = new javachart.chart.LabelLineChart("Test Chart");
		loadMarkers();
	...
	void loadMarkers(){
		...
		for(int i=0;i<markerNames.length;i++){
			...
			markerImages[i] = loadImage(markerNames[i] + ".gif");
	...
	public static void main (String[] args) {
		...
		LabelLineChart 		b = new LabelLineChart();
