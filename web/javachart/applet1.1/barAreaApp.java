...
import javachart.chart.BarAreaChart;

public class barAreaApp extends ChartAppShell {

	//overloads the public init to build a bar/area combo
	public void init () {
			  
		chart = new BarAreaChart("My Chart");
		getOptions();			   
		getMyOptions();
		getAxisOptions();
	...
	public void getMyOptions() {
		...
		String 		str;
		BarAreaChart	c;
		c = (BarAreaChart) chart;

		for(int i=0;i<20;i++){
	 			str = getParameter("dataset" + i + "Type");
	 			if(str != null){
	 				if(str.equals("Bar")) 
	 					c.dataAllocation[i] = BarAreaChart.BAR;
	 				else if(str.equals("Area")) 
	 					c.dataAllocation[i] = BarAreaChart.AREA;
			}
		}
