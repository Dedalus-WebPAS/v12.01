...
import javachart.chart.StackBarChart;


public class cornellBar extends javachart.applet.ChartAppShell {

	Vector	rows;
	          
        public void init () {
              
		chart = new StackBarChart("My Chart");
		getOptions();
		getMyOptions();
		getAxisOptions();
