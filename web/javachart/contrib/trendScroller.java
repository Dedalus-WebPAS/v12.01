...
public class trendScroller extends ChartAppShell {
	...
	public void getMyOptions() {
		...
		TwinAxisChart lineChart = (TwinAxisChart) chart;
		lineChart.getLine().setClip(true);
		lineChart.getAuxLine().setClip(true);
	...
	protected void getAxisOptions(){
		...
		TwinAxisChart tChart = (TwinAxisChart) chart;
	...
	public boolean getDatasetParameters(	int 	which,
		...
		if(str != null) {
			if(str.equals("right")){
				TwinAxisChart t = (TwinAxisChart)chart;
	...
	public void paint(Graphics g){
		...
		offScreenImage = null;
		super.paint(g);
		//chart.drawGraph(g);   //this is faster (no dbl buffering) but misses markers
	}
