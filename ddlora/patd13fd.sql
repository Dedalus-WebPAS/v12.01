...
(
  ...
  ptxdall1    number(3,0) default 0 not null,
  ptxdahl1    number(3,0) default 0 not null,
  pt0d2agp    varchar2(1) default ' ' not null,
  ptxdall2    number(3,0) default 0 not null,
  ptxdahl2    number(3,0) default 0 not null,
  ...
  dpt0dvxc    varchar2(1) default ' ' not null,
  ptodmeth    varchar2(1) default ' ' not null,
  dpt0dvx1    varchar2(1) default ' ' not null,
  dpt0dvx2    varchar2(1) default ' ' not null,
  dpt0dvx3    varchar2(1) default ' ' not null,
  pt0dcarq    varchar2(1) default ' ' not null,
  ptdspr13    varchar2(48) default ' ' not null,
  lf          varchar2(1) default ' ' not null,
constraint patd13a1 primary key( 
dpcode)
)
tablespace pas_data 
